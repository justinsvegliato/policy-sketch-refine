...
def plotter(baseline_config_file, config_file_0, config_file_1, config_file_2, config_file_a, data_dir):
...
def plot_all(config_files, data_dir):
    baseline_config_file = config_files[4]
    config_file_0 = config_files[0]
    config_file_1 = config_files[1]
    config_file_2 = config_files[2]
    config_file_a = config_files[3]
    plotter(baseline_config_file, config_file_0, config_file_1, config_file_2, config_file_a, data_dir)
